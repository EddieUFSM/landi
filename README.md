...
Esse projeto foi concebido para explorar minhas habilidades como designer com CSS. É um projeto feito primariamente focado no css sem a utilização de nenhuma biblioteca como bootstrap ou MUI.
